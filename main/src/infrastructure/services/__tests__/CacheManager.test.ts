...
describe('CacheManager', () => {
    ...
    describe('Constructor', () => {
        ...
        test('should start cleanup timer', () => {
            const setIntervalSpy = vi.spyOn(global, 'setInterval')
            new CacheManager({ cleanupInterval: 10000 })
    ...
    describe('get', () => {
        ...
        test('should increment hit count on access', () => {
            const cache = new CacheManager<string>()
        ...
        test('should delete expired item from cache', () => {
            const cache = new CacheManager<string>({ defaultTTL: 1000 })
    ...
    describe('has', () => {
        ...
        test('should return false for expired item', () => {
            const cache = new CacheManager<string>({ defaultTTL: 1000 })
    ...
    describe('getStats', () => {
        ...
        test('should count expired items', () => {
            const cache = new CacheManager<string>({ defaultTTL: 1000 })
    ...
    describe('cleanup', () => {
        test('should remove expired items automatically', () => {
            const cache = new CacheManager<string>({
                defaultTTL: 1000,
        ...
        test('should only remove expired items', () => {
            const cache = new CacheManager<string>({
                cleanupInterval: 5000,
            })
    ...
    describe('destroy', () => {
        test('should clear cache and stop cleanup timer', () => {
    ...
    describe('TTL and Expiration', () => {
        ...
        test('should override default TTL with custom TTL', () => {
            const cache = new CacheManager<string>({ defaultTTL: 5000 })
    ...
    describe('Global Cache Instances', () => {
        test('should export configured cache instances', async () => {
    ...
    describe('Edge Cases', () => {
        test('should no-op when evictLRU runs on empty cache', () => {
            const cache = new CacheManager<string>()
        ...
        test('should handle concurrent get while cleanup runs', () => {
            const cache = new CacheManager<string>({
                defaultTTL: 1000,
                cleanupInterval: 500,
            })
