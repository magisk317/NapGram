...
describe('MessageQueue', () => {
    ...
    describe('enqueue', () => {
        ...
        test('should start processing when first message is enqueued', async () => {
        ...
        test('should handle priority messages', async () => {
    ...
    describe('processBatch', () => {
        test('should process messages in batch', async () => {
            const queue = new MessageQueue(mockHandler, {
                batchSize: 2,
                processInterval: 100,
            })
        ...
        test('should sort by priority when enabled', async () => {
        ...
        test('should record message latency', async () => {
            const queue = new MessageQueue(mockHandler, { processInterval: 100 })
    ...
    describe('destroy', () => {
        test('should stop processing and clear queue', async () => {
            const queue = new MessageQueue(mockHandler, { processInterval: 100 })
        ...
        test('should handle destroy before processing starts', () => {
            const queue = new MessageQueue(mockHandler)
        ...
        test('should prevent further processing after destroy', async () => {
            const queue = new MessageQueue(mockHandler, { processInterval: 100 })
    ...
    describe('Edge Cases', () => {
        test('should handle rapid consecutive enqueues', async () => {
            const queue = new MessageQueue(mockHandler, { processInterval: 100 })
        ...
        test('should handle handler that takes time to process', async () => {
        ...
        test('should ignore repeated startProcessing calls', () => {
            const queue = new MessageQueue(mockHandler, { processInterval: 100 })
        ...
        test('should not start multiple processing timers', async () => {
            const queue = new MessageQueue(mockHandler, { processInterval: 100 })
